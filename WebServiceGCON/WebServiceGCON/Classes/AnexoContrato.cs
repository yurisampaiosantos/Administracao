...
namespace WebServiceGCON
{
    public class AnexoContrato
    {
        ...
        {
            string sql = "";
            sql += " SELECT GCO_ANEXO_CONTRATO_MENSAL.ID,  GCO_CONTRATO_MENSAL.ID AS CONTRATO_ID, GCO_ANEXO_CONTRATO_MENSAL.BLOB_CONTENT,  GCO_ANEXO_CONTRATO_MENSAL.FILENAME,";
            sql += " GCO_CONTRATO_MENSAL.MES,  GCO_CONTRATO_MENSAL.ANO, GCO_ANEXO_CONTRATO_MENSAL.DIRETORIO";
            sql += " FROM GCO_ANEXO_CONTRATO_MENSAL,  GCO_CONTRATO_MENSAL";
            sql += " WHERE GCO_CONTRATO_MENSAL.ID = GCO_ANEXO_CONTRATO_MENSAL.CONTRATO_MENSAL_ID";
            sql += " AND GCO_ANEXO_CONTRATO_MENSAL.ID = " + anexoId;
        ...
        {
            string sql = "";
            sql += " UPDATE GCO_ANEXO_CONTRATO_MENSAL SET  ";
