...
{
    public partial class frmInfoR4010 : Form
    {
        private R4010DAL objEvento;

        public frmInfoR4010()
        {
            InitializeComponent();
            objEvento = new R4010DAL();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            R4010DAL ojbEvento = new R4010DAL();
        ...
        private void frmInfoR4010_Load(object sender, EventArgs e)
        {
            ...
            if (dgvEventos.SelectedRows.Count > 0)
            {
               /* int idReg = Convert.ToInt32(dgvEventos.Rows[dgvEventos.SelectedRows[0].Index].Cells["idReg"].Value.ToString());
                ...
                {*/
                    ...
                    frmDadosR4010 f = new frmDadosR4010();
                    if (dgvEventos.Rows[dgvEventos.SelectedRows[0].Index].Cells["status"].Value.ToString() == "E")
                    {
                        f.edicao = false;
                    }
                    ...
                    f._idReg4010 = Convert.ToInt32(dt.Rows[dgvEventos.SelectedRows[0].Index]["idReg"].ToString());
                    f.ShowDialog();
               // }
            }
        }
        ...
        private void importarXLSToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (vAbreArq.ShowDialog() == DialogResult.OK)
            {
                ...
                OleDbDataAdapter da = new OleDbDataAdapter("Select * From [R4010$]", conexao);
                da.Fill(ds);
                ...
                objEvento.carregaR4010Temp(ds);
                objEvento.preencherR4010();
                AtualizaGrid();                
            }
        ...
        {
            frmNovoR4010 f = new frmNovoR4010();
            f.ShowDialog();
            AtualizaGrid();
        }
